...
export const { port, smtp, smtpPort, emailConfig, defaultZipName, urlRoot, logDir, administrators, tapisDBConfig, databaseConnections, tapisConfig, tapisV3Config, githubWebhookSecret, licenseFile } = config;
