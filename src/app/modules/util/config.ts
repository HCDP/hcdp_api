...
export const { port, smtp, smtpPort, emailConfig, defaultZipName, urlRoot, logDir, administrators, tapisDBConfig, databaseConnections, tapisConfig, githubWebhookSecret, licenseFile } = config;
